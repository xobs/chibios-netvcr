...
extern           void USBD_CDC_ACM_EP_INTIN_Event       (uint32_t event);
extern           void USBD_CDC_ACM_EP_BULKIN_Event      (uint32_t event);
extern           void USBD_CDC_ACM_EP_BULKOUT_Event     (uint32_t event);
extern           void USBD_CDC_ACM_EP_BULK_Event        (uint32_t event);
