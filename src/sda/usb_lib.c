...
//#if    (USBD_ENABLE)
        ...
        uint8_t   USBD_AltSetting[USBD_IF_NUM];
        uint8_t   USBD_EP0Buf    [USBD_MAX_PACKET0];
const   uint8_t   usbd_power                 =  USBD_POWER;
const   uint8_t   usbd_hs_enable             =  USBD_HS_ENABLE;
const   uint16_t  usbd_if_num                =  USBD_IF_NUM;
const   uint8_t   usbd_ep_num                =  USBD_EP_NUM;
const   uint8_t   usbd_max_packet0           =  USBD_MAX_PACKET0;
...
#if    (USBD_HID_ENABLE)
const   uint8_t   usbd_hid_if_num            =  USBD_HID_IF_NUM;
const   uint8_t   usbd_hid_ep_intin          =  USBD_HID_EP_INTIN;
const   uint8_t   usbd_hid_ep_intout         =  USBD_HID_EP_INTOUT;
const   uint16_t  usbd_hid_interval     [2]  = {USBD_HID_INTERVAL,       USBD_HID_HS_INTERVAL};
const   uint16_t  usbd_hid_maxpacketsize[2]  = {USBD_HID_WMAXPACKETSIZE, USBD_HID_HS_WMAXPACKETSIZE};
const   uint8_t   usbd_hid_inreport_num      =  USBD_HID_INREPORT_NUM;
const   uint8_t   usbd_hid_outreport_num     =  USBD_HID_OUTREPORT_NUM;
const   uint16_t  usbd_hid_inreport_max_sz   =  USBD_HID_INREPORT_MAX_SZ;
const   uint16_t  usbd_hid_outreport_max_sz  =  USBD_HID_OUTREPORT_MAX_SZ;
const   uint16_t  usbd_hid_featreport_max_sz =  USBD_HID_FEATREPORT_MAX_SZ;
        uint16_t  USBD_HID_PollingCnt;
        uint8_t   USBD_HID_IdleCnt             [USBD_HID_INREPORT_NUM];
        uint8_t   USBD_HID_IdleReload          [USBD_HID_INREPORT_NUM];
        uint8_t   USBD_HID_IdleSet             [USBD_HID_INREPORT_NUM];
        uint8_t   USBD_HID_InReport            [USBD_HID_INREPORT_MAX_SZ+1];
        uint8_t   USBD_HID_OutReport           [USBD_HID_OUTREPORT_MAX_SZ+1];
        uint8_t   USBD_HID_FeatReport          [USBD_HID_FEATREPORT_MAX_SZ+1];
#endif

#if    (USBD_MSC_ENABLE)
const   uint8_t   usbd_msc_if_num            =  USBD_MSC_IF_NUM;
const   uint8_t   usbd_msc_ep_bulkin         =  USBD_MSC_EP_BULKIN;
const   uint8_t   usbd_msc_ep_bulkout        =  USBD_MSC_EP_BULKOUT;
const   uint16_t  usbd_msc_maxpacketsize[2]  = {USBD_MSC_WMAXPACKETSIZE, USBD_MSC_HS_WMAXPACKETSIZE};
const   char     *usbd_msc_inquiry_data      =  USBD_MSC_INQUIRY_DATA;
        uint8_t   USBD_MSC_BulkBuf             [USBD_MSC_MAX_PACKET*USBD_MSC_ENABLE];
#endif

#if    (USBD_ADC_ENABLE)
const   uint8_t   usbd_adc_cif_num           =  USBD_ADC_CIF_NUM;
const   uint8_t   usbd_adc_sif1_num          =  USBD_ADC_SIF1_NUM;
const   uint8_t   usbd_adc_sif2_num          =  USBD_ADC_SIF2_NUM;
const   uint8_t   usbd_adc_ep_isoout         =  USBD_ADC_EP_ISOOUT;
const   uint32_t  usbd_adc_cfg_datafreq      =  USBD_ADC_TSAMFREQ;
const   uint32_t  usbd_adc_cfg_p_s           =  USBD_ADC_CFG_P_S;
const   uint32_t  usbd_adc_cfg_p_c           =  USBD_ADC_CFG_P_C;
const   uint32_t  usbd_adc_cfg_b_s           =  (8*USBD_ADC_CFG_P_C*USBD_ADC_CFG_P_S);
        int16_t  USBD_ADC_DataBuf              [8*USBD_ADC_CFG_P_C*USBD_ADC_CFG_P_S];
#endif
...
const   uint8_t   usbd_cdc_acm_cif_num       =  USBD_CDC_ACM_CIF_NUM;
const   uint8_t   usbd_cdc_acm_dif_num       =  USBD_CDC_ACM_DIF_NUM;
const   uint8_t   usbd_cdc_acm_ep_intin      =  USBD_CDC_ACM_EP_INTIN;
const   uint8_t   usbd_cdc_acm_ep_bulkin     =  USBD_CDC_ACM_EP_BULKIN;
const   uint8_t   usbd_cdc_acm_ep_bulkout    =  USBD_CDC_ACM_EP_BULKOUT;
const   uint16_t  usbd_cdc_acm_sendbuf_sz    =  USBD_CDC_ACM_SENDBUF_SIZE;
const   uint16_t  usbd_cdc_acm_receivebuf_sz =  USBD_CDC_ACM_RECEIVEBUF_SIZE;
const   uint16_t  usbd_cdc_acm_maxpacketsize [2] = {USBD_CDC_ACM_WMAXPACKETSIZE,  USBD_CDC_ACM_HS_WMAXPACKETSIZE};
const   uint16_t  usbd_cdc_acm_maxpacketsize1[2] = {USBD_CDC_ACM_WMAXPACKETSIZE1, USBD_CDC_ACM_HS_WMAXPACKETSIZE1};
        uint8_t   USBD_CDC_ACM_SendBuf         [USBD_CDC_ACM_SENDBUF_SIZE];
        uint8_t   USBD_CDC_ACM_ReceiveBuf      [USBD_CDC_ACM_RECEIVEBUF_SIZE];
        uint8_t   USBD_CDC_ACM_NotifyBuf       [10];
#endif
 ...
 *----------------------------------------------------------------------------*/
  ...
  #endif
#else
  bool USBD_ReqGetDescriptor_HID          (uint8_t **pD, uint32_t *len)                           { return (false); }
  bool USBD_EndPoint0_Setup_HID_ReqToIF   (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_HID_ReqToIF     (void)                                        { return (false); }
  ...
  #endif
#else
  void USBD_ReqClrFeature_MSC             (uint32_t EPNum)                                   { }
  bool USBD_EndPoint0_Setup_MSC_ReqToIF   (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_MSC_ReqToIF     (void)                                        { return (false); }
#endif  /* (USBD_MSC_ENABLE) */

#if    (USBD_ADC_ENABLE == 0)
  bool USBD_EndPoint0_Setup_ADC_ReqToIF   (void)                                        { return (false); }
  bool USBD_EndPoint0_Setup_ADC_ReqToEP   (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_ADC_ReqToIF     (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_ADC_ReqToEP     (void)                                        { return (false); }
#endif  /* (USBD_MSC_ENABLE) */
  ...
  #endif
#else
  bool USBD_EndPoint0_Setup_CDC_ReqToIF(void)                                       { return (false); }
  bool USBD_EndPoint0_Out_CDC_ReqToIF (void)                                        { return (false); }
#endif  /* (USBD_CDC_ACM_ENABLE) */

#if    (USBD_CLS_ENABLE)
#else
  bool USBD_EndPoint0_Setup_CLS_ReqToDEV  (void)                                        { return (false); }
  bool USBD_EndPoint0_Setup_CLS_ReqToIF   (void)                                        { return (false); }
  bool USBD_EndPoint0_Setup_CLS_ReqToEP   (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_CLS_ReqToDEV    (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_CLS_ReqToIF     (void)                                        { return (false); }
  bool USBD_EndPoint0_Out_CLS_ReqToEP     (void)                                        { return (false); }
...
__attribute__((weak))   void USBD_Power_Event       (bool power);
__attribute__((weak))   void USBD_Reset_Event       (void);
__attribute__((weak))   void USBD_Suspend_Event     (void);
__attribute__((weak))   void USBD_Resume_Event      (void);
__attribute__((weak))   void USBD_WakeUp_Event      (void);
__attribute__((weak))   void USBD_SOF_Event         (void);
__attribute__((weak))   void USBD_Error_Event       (uint32_t error);
...
void (* const USBD_P_Error_Event    )(uint32_t error)  = USBD_Error_Event;

/* USB Device - Endpoint Events Callback Functions */
extern   void USBD_EndPoint0         (uint32_t event);
#ifndef       USBD_EndPoint1
__attribute__((weak))   void USBD_EndPoint1         (uint32_t event);
#endif
#ifndef       USBD_EndPoint2
__attribute__((weak))   void USBD_EndPoint2         (uint32_t event);
#endif
#ifndef       USBD_EndPoint3
__attribute__((weak))   void USBD_EndPoint3         (uint32_t event);
#endif
#ifndef       USBD_EndPoint4
__attribute__((weak))   void USBD_EndPoint4         (uint32_t event);
#endif
#ifndef       USBD_EndPoint5
__attribute__((weak))   void USBD_EndPoint5         (uint32_t event);
#endif
#ifndef       USBD_EndPoint6
__attribute__((weak))   void USBD_EndPoint6         (uint32_t event);
#endif
#ifndef       USBD_EndPoint7
__attribute__((weak))   void USBD_EndPoint7         (uint32_t event);
#endif
#ifndef       USBD_EndPoint8
__attribute__((weak))   void USBD_EndPoint8         (uint32_t event);
#endif
#ifndef       USBD_EndPoint9
__attribute__((weak))   void USBD_EndPoint9         (uint32_t event);
#endif
#ifndef       USBD_EndPoint10
__attribute__((weak))   void USBD_EndPoint10        (uint32_t event);
#endif
#ifndef       USBD_EndPoint11
__attribute__((weak))   void USBD_EndPoint11        (uint32_t event);
#endif
#ifndef       USBD_EndPoint12
__attribute__((weak))   void USBD_EndPoint12        (uint32_t event);
#endif
#ifndef       USBD_EndPoint13
__attribute__((weak))   void USBD_EndPoint13        (uint32_t event);
#endif
#ifndef       USBD_EndPoint14
__attribute__((weak))   void USBD_EndPoint14        (uint32_t event);
#endif
#ifndef       USBD_EndPoint15
__attribute__((weak))   void USBD_EndPoint15        (uint32_t event);
#endif

/* USB Device - Endpoint Events Callback Pointers */
void (* const USBD_P_EP[16])         (uint32_t event) = {
  USBD_EndPoint0,
  USBD_EndPoint1,
  USBD_EndPoint2,
  USBD_EndPoint3,
...
__attribute__((weak))   void USBD_Configure_Event   (void);
__attribute__((weak))   void USBD_Interface_Event   (void);
__attribute__((weak))   void USBD_Feature_Event     (void);
...
#ifdef __RTX
const bool __rtx = true;

#if   ((USBD_HID_ENABLE) || (USBD_ADC_ENABLE) || (USBD_CDC_ACM_ENABLE) || (USBD_CLS_ENABLE))
__attribute__((weak)) void USBD_RTX_Device     (void)   {
  uint16_t evt;
...
__attribute__((weak)) void USBD_RTX_EndPoint1  (void);
#endif
#ifndef       USBD_RTX_EndPoint2
__attribute__((weak)) void USBD_RTX_EndPoint2  (void);
#endif
#ifndef       USBD_RTX_EndPoint3
__attribute__((weak)) void USBD_RTX_EndPoint3  (void);
#endif
#ifndef       USBD_RTX_EndPoint4
__attribute__((weak)) void USBD_RTX_EndPoint4  (void);
#endif
#ifndef       USBD_RTX_EndPoint5
__attribute__((weak)) void USBD_RTX_EndPoint5  (void);
#endif
#ifndef       USBD_RTX_EndPoint6
__attribute__((weak)) void USBD_RTX_EndPoint6  (void);
#endif
#ifndef       USBD_RTX_EndPoint7
__attribute__((weak)) void USBD_RTX_EndPoint7  (void);
#endif
#ifndef       USBD_RTX_EndPoint8
__attribute__((weak)) void USBD_RTX_EndPoint8  (void);
#endif
#ifndef       USBD_RTX_EndPoint9
__attribute__((weak)) void USBD_RTX_EndPoint9  (void);
#endif
#ifndef       USBD_RTX_EndPoint10
__attribute__((weak)) void USBD_RTX_EndPoint10 (void);
#endif
#ifndef       USBD_RTX_EndPoint11
__attribute__((weak)) void USBD_RTX_EndPoint11 (void);
#endif
#ifndef       USBD_RTX_EndPoint12
__attribute__((weak)) void USBD_RTX_EndPoint12 (void);
#endif
#ifndef       USBD_RTX_EndPoint13
__attribute__((weak)) void USBD_RTX_EndPoint13 (void);
#endif
#ifndef       USBD_RTX_EndPoint14
__attribute__((weak)) void USBD_RTX_EndPoint14 (void);
#endif
#ifndef       USBD_RTX_EndPoint15
__attribute__((weak)) void USBD_RTX_EndPoint15 (void);
#endif

#if    (USBD_HID_ENABLE)
__attribute__((weak)) void USBD_RTX_Core       (void) {
  uint16_t evt;
...
void usbd_os_evt_set     (uint16_t event_flags, uint32_t task)                  { if (task) { os_evt_set(event_flags, task); } }
uint16_t  usbd_os_evt_get     (void)                                       { return (os_evt_get()); }
uint32_t  usbd_os_evt_wait_or (uint16_t wait_flags, uint16_t timeout)                { return (os_evt_wait_or (wait_flags, timeout)); }

#else
const bool __rtx = false;

void usbd_os_evt_set     (uint16_t event_flags, uint32_t task)                  { }
uint16_t  usbd_os_evt_get     (void)                                       { return (0); }
uint32_t  usbd_os_evt_wait_or (uint16_t wait_flags, uint16_t timeout)                { return (0); }
#endif
...
__attribute__((weak)) \
const uint8_t USBD_HID_ReportDescriptor[] = {
...
__attribute__((weak)) \
const uint16_t USBD_HID_ReportDescriptorSize = sizeof(USBD_HID_ReportDescriptor);

__attribute__((weak)) \
const uint16_t USBD_HID_DescriptorOffset     = USBD_HID_DESC_OFS;
...
__attribute__((weak)) \
const uint8_t USBD_DeviceQualifier[] = {
...
__attribute__((weak)) \
const uint8_t USBD_DeviceQualifier_HS[] = {
  USB_DEVICE_QUALI_SIZE,                /* bLength */
  USB_DEVICE_QUALIFIER_DESCRIPTOR_TYPE, /* bDescriptorType */
  WBVAL(0x0200), /* 2.00 */             /* bcdUSB */
  0x00,                                 /* bDeviceClass */
...
/* USB Device Qualifier Descriptor (for Full Speed) */
__attribute__((weak)) \
const uint8_t USBD_DeviceQualifier[]    = { 0 };

/* USB Device Qualifier Descriptor for High Speed */
__attribute__((weak)) \
const uint8_t USBD_DeviceQualifier_HS[] = { 0 };
#endif
...
__attribute__((weak)) \
const uint8_t USBD_ConfigDescriptor_HS[] = { 0 };
__attribute__((weak)) \
const uint8_t USBD_OtherSpeedConfigDescriptor[] = { 0 };
__attribute__((weak)) \
const uint8_t USBD_OtherSpeedConfigDescriptor_HS[] = { 0 };
#else

/* USB Device Configuration Descriptor (for High Speed) */
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__attribute__((weak)) \
const uint8_t USBD_ConfigDescriptor_HS[] = {
/* Configuration 1 */
  USB_CONFIGUARTION_DESC_SIZE,          /* bLength */
  USB_CONFIGURATION_DESCRIPTOR_TYPE,    /* bDescriptorType */
  WBVAL(USBD_WTOTALLENGTH),             /* wTotalLength */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__attribute__((weak)) \
const uint8_t USBD_OtherSpeedConfigDescriptor[] = {
/* Configuration 1 */
  USB_CONFIGUARTION_DESC_SIZE,          /* bLength */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__attribute__((weak)) \
const uint8_t USBD_OtherSpeedConfigDescriptor_HS[] = {
/* Configuration 1 */
  USB_CONFIGUARTION_DESC_SIZE,          /* bLength */
  USB_OTHER_SPEED_CONFIG_DESCRIPTOR_TYPE, /* bDescriptorType */
  WBVAL(USBD_WTOTALLENGTH),             /* wTotalLength */
...
#warning "This is kinda important"
#if 0
#define USBD_STR_DEF(n)                 \
  struct {                              \
    uint8_t  len;                            \
    uint8_t  type;                           \
    uint16_t str[sizeof(USBD_##n)/2-1];      \
  } desc##n
