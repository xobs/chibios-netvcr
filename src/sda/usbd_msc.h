...
extern        void USBD_MSC_EP_BULKIN_Event      (uint32_t event);
extern        void USBD_MSC_EP_BULKOUT_Event     (uint32_t event);
extern        void USBD_MSC_EP_BULK_Event        (uint32_t event);
