...
const PALConfig pal_default_config =
{
  .ports = {
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_INPUT_PULLUP,    /* PTB1*/ PAL_MODE_INPUT,           /* PTB2*/ PAL_MODE_UNCONNECTED,   // FPGA_DRIVE, MCU_F_INIT, NC
    ...
    },
    {
      .port = IOPORT3,  // PORTC
      .pads = {
        /* PTC0*/ PAL_MODE_UNCONNECTED,     /* PTC1*/ PAL_MODE_INPUT_PULLUP,    /* PTC2*/ PAL_MODE_INPUT_PULLUP,  // NC, MCU_F_PROG, MCU_F_DONE
